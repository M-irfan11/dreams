...
<div class="page-wrapper">
    <div class="content">
        ...
        <?php
            // Session message (set by purchase_return/store.php, edit.php, delete.php)
            ...
            $returns = $crud->common_query('SELECT purchase_return.*, suppliers.name as supplier_name, users.full_name FROM `purchase_return`
                JOIN suppliers on suppliers.id=purchase_return.supplier_id
                LEFT JOIN users on users.id=purchase_return.created_by
                WHERE purchase_return.deleted_at IS NULL
                ORDER BY purchase_return.id DESC');
        ?>
        ...
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="<?php echo $base_url; ?>purchase_return/create.php" class="btn btn-added">
                    <img src="<?php echo $base_url; ?>assets/img/icons/plus.svg" alt="img">Add New Purchase Return
                </a>
            </div>
        </div>
