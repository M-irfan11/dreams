...
<!-- Sidebar End -->
 <?php
    ...
    $accheadsDatacr=[];
    $accountHeadscr = $crud->common_query("SELECT id, account_name FROM account_heads WHERE account_subtype ='Current Asset' and deleted_at IS NULL"); 
    if($accountHeadscr['status']) {
        foreach ($accountHeadscr['data'] as $head) {
            $accheadsDatacr[] = [
                'id' => $head->id,
        ...
        <form action="store.php" method="POST">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <select name="pay_cr" class="form-control" required>
                        <?php foreach ($accheadsDatacr as $head): ?>
...
<script>
    document.getElementById('addRowBtn').addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                ...
                <td><input type="number" oninput="calculateTotal()" name="dr[]" class="form-control"></td>
