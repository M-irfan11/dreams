...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="<?php echo $base_url; ?>sales/edit.php?id=<?php echo $id; ?>" method="POST">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label>Sale Date</label>
                                <input autocomplete="off" value="<?php echo $sale->sale_date; ?>" name="sale_date" type="date" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="warehouse_id" class="select form-control">
                                    ...
                                    ?>
                                                <option value="<?php echo $warehouse->id; ?>" <?php echo ($warehouse->id == $sale->warehouse_id) ? 'selected' : ''; ?>><?php echo htmlspecialchars($warehouse->warehouse_name); ?></option>
                                    <?php   }
                                        } else { ?>
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select name="status" class="select form-control">
                                    <option value="1" <?php echo ($sale->status == 1) ? 'selected' : ''; ?>>Paid</option>
                                    <option value="2" <?php echo ($sale->status == 2) ? 'selected' : ''; ?>>Pending</option>
                                    <option value="3" <?php echo ($sale->status == 3) ? 'selected' : ''; ?>>Cancelled</option>
                                </select>
                            </div>
                        </div>
                    </div>
