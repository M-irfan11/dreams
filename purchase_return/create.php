...
<div class="page-wrapper">
    <div class="content">
        ...
        <?php
            // Session message (set by store.php on failure)
        ...
        <?php elseif(empty($purchase->warehouse_id)): ?>
            <!-- can't process a stock return without knowing which warehouse to remove it from -->
            <div class="alert alert-danger">
                Purchase #<?php echo $purchase->id; ?> has no warehouse on record, so returned stock cannot be removed from anywhere. Please contact an administrator.
            </div>
                ...
                <div class="card-body">
                    <form action="<?php echo $base_url; ?>purchase_return/store.php" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="form-group">
                                    <label>Returning From Warehouse</label>
                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($purchase->warehouse_name); ?>" readonly>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="hidden" name="unit_price[]" value="<?php echo $item->purchase_price; ?>">
                                        </td>
                                        <td><?php echo $item->quantity; ?></td>
                                        <td><?php echo $item->remaining_qty; ?></td>
                                        <td>
                                            <input name="quantity[]" type="number" min="0" max="<?php echo $item->remaining_qty; ?>" value="0"
                                                class="form-control return-qty" data-price="<?php echo $item->purchase_price; ?>" data-index="<?php echo $index; ?>">
                                        </td>
...
<?php endif; ?>
>>>>>>> b771f0d8efeb6d1890b3732653ab56dc62acb307
